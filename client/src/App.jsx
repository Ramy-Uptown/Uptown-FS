...
{JSON.stringify(health, null, 2)}
        ...
        <section style={styles.section}>
          ...
          <div style={styles.grid2}>
            ...
            <div>
              <label style={styles.label}>Unit Type («نوع الوحد)</>)la_code>
            ...
            <div>
              <label style={styles.label}>Unit Code («كود الوحد)</>)la_code>
        ...
        <section style={styles.section}>
          ...
          <div style={styles.grid2}>
            ...
            <div>
              <label style={styles.label}>Reservation Payment Date («تاريخ سداد دفعة الحج)</>)la_code>
            ...
            <div>
              <label style={styles.label}>Delivery Period («مدة التسلي)</>)la_code>
