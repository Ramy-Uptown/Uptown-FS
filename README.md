...
- Payment Schedule Arabic improvements: The “الوصف” column now shows Arabic translations for schedule items like Down Payment, Equal Installment, Handover, Maintenance Fee, Garage Fee, and Year N (frequency). The description column is center-aligned for better readability in Arabic. File: client/src/components/calculator/PaymentSchedule.jsx.
